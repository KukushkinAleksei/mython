...
void TestMethodInvocation() {
  ...
  auto base_method_1 = [&base_closure, &context](Closure& closure,
                                                 Context& ctx) {
    ASSERT_EQUAL(&context, &ctx);
    base_closure = closure;
    return ObjectHolder::Own(Number{123});
  };
  auto base_method_2 = [&base_closure, &context](Closure& closure,
                                                 Context& ctx) {
    ASSERT_EQUAL(&context, &ctx);
    base_closure = closure;
  ...
  base_methods.push_back({"test"s,
                          {"arg1"s, "arg2"s},
                          make_unique<TestMethodBody>(base_method_1)});
  base_methods.push_back(
      {"test_2"s, {"arg1"s}, make_unique<TestMethodBody>(base_method_2)});
  ...
  auto res = base_inst.Call(
      "test"s,
      {ObjectHolder::Own(Number{1}), ObjectHolder::Own(String{"abc"s})},
      context);
  ...
  ASSERT(
      Equal(base_closure.at("arg1"s), ObjectHolder::Own(Number{1}), context));
  ASSERT_EQUAL(base_closure.count("arg2"s), 1U);
  ASSERT(Equal(base_closure.at("arg2"s), ObjectHolder::Own(String{"abc"s}),
               context));
  ASSERT_EQUAL(base_closure.count("base_field"s), 0U);

  Closure child_closure;
  auto child_method_1 = [&child_closure, &context](Closure& closure,
                                                   Context& ctx) {
    ASSERT_EQUAL(&context, &ctx);
  ...
  ASSERT_EQUAL(base_closure.count("arg1"s), 1U);
  ASSERT(Equal(base_closure.at("arg1"s), (ObjectHolder::Own(String{":)"s})),
               context));

  ASSERT(!child_inst.HasMethod("test"s, 1U));
  ASSERT_THROWS(child_inst.Call("test"s, {ObjectHolder::None()}, context),
                runtime_error);
}
...
void TestComparison() {
  ...
  auto test_less = [](const ObjectHolder& lhs, const ObjectHolder& rhs,
                      bool less_result) {
    DummyContext ctx;
  ...
  // Numbers
  {
    test_equal(ObjectHolder::Own(Number{3}), ObjectHolder::Own(Number{3}),
               true);
    test_equal(ObjectHolder::Own(Number{3}), ObjectHolder::Own(Number{4}),
               false);
    test_equal(ObjectHolder::Own(Number{4}), ObjectHolder::Own(Number{3}),
               false);

    test_less(ObjectHolder::Own(Number{3}), ObjectHolder::Own(Number{4}), true);
    test_less(ObjectHolder::Own(Number{3}), ObjectHolder::Own(Number{3}),
              false);
    test_less(ObjectHolder::Own(Number{3}), ObjectHolder::Own(Number{2}),
              false);

    test_greater(ObjectHolder::Own(Number{4}), ObjectHolder::Own(Number{2}),
                 true);
    test_greater(ObjectHolder::Own(Number{3}), ObjectHolder::Own(Number{3}),
                 false);
    test_greater(ObjectHolder::Own(Number{2}), ObjectHolder::Own(Number{3}),
                 false);
    ...
    test_gt_uncomparable(ObjectHolder::Own(Number{0}),
                         ObjectHolder::Own(String{"test"s}));
  }

  // Strings
  {
    test_equal(ObjectHolder::Own(String{""s}), ObjectHolder::Own(String{""s}),
               true);
    test_equal(ObjectHolder::Own(String{"1"s}), ObjectHolder::Own(String{""s}),
               false);
    test_equal(ObjectHolder::Own(String{""s}), ObjectHolder::Own(String{"1"s}),
               false);
    ...
    test_less(ObjectHolder::Own(String{""s}), ObjectHolder::Own(String{"1"s}),
              true);
    test_less(ObjectHolder::Own(String{"abb"s}),
              ObjectHolder::Own(String{"abc"s}), true);
    test_less(ObjectHolder::Own(String{""s}), ObjectHolder::Own(String{""s}),
              false);
    ...
    test_greater(ObjectHolder::Own(String{""s}), ObjectHolder::Own(String{""s}),
                 false);
    test_greater(ObjectHolder::Own(String{"abc"s}),
                 ObjectHolder::Own(String{"abc"s}), false);
  ...
  // Booleans
  {
    test_equal(ObjectHolder::Own(Bool{true}), ObjectHolder::Own(Bool{true}),
               true);
    test_equal(ObjectHolder::Own(Bool{false}), ObjectHolder::Own(Bool{false}),
               true);
    test_equal(ObjectHolder::Own(Bool{false}), ObjectHolder::Own(Bool{true}),
               false);
    test_equal(ObjectHolder::Own(Bool{true}), ObjectHolder::Own(Bool{false}),
               false);

    test_less(ObjectHolder::Own(Bool{false}), ObjectHolder::Own(Bool{true}),
              true);
    test_less(ObjectHolder::Own(Bool{true}), ObjectHolder::Own(Bool{true}),
              false);
    test_less(ObjectHolder::Own(Bool{false}), ObjectHolder::Own(Bool{false}),
              false);
    test_less(ObjectHolder::Own(Bool{true}), ObjectHolder::Own(Bool{false}),
              false);

    test_greater(ObjectHolder::Own(Bool{false}), ObjectHolder::Own(Bool{true}),
                 false);
    test_greater(ObjectHolder::Own(Bool{true}), ObjectHolder::Own(Bool{true}),
                 false);
    test_greater(ObjectHolder::Own(Bool{false}), ObjectHolder::Own(Bool{false}),
                 false);
    test_greater(ObjectHolder::Own(Bool{true}), ObjectHolder::Own(Bool{false}),
                 true);
  ...
  // None
  {
    ...
    test_eq_uncomparable(ObjectHolder::None(),
                         ObjectHolder::Own(String{"None"s}));
...
void TestClass() {
  ...
  auto body = [&passed_closure, &passed_context](Closure& closure,
                                                 Context& ctx) {
  ...
  methods.push_back(
      {"method"s, {"arg1"s, "arg2"s}, make_unique<TestMethodBody>(body)});
...
void TestClassInstance() {
  ...
  auto str_body = [&passed_closure](Closure& closure,
                                    [[maybe_unused]] Context& ctx) {
    passed_closure = closure;
